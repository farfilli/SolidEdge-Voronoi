...
'                    Dim blockPaths = BuildBlockSymbolPaths(cell, canvas.BlockSymbolLoops, canvas.CellScale, canvas.RandomRotation)
...
'                                       randomRotation As Boolean) As List(Of ExportPath2D)
